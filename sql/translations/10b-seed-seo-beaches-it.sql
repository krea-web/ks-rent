-- ============================================================
-- 10b - SEED IT seo_beaches (ricostruzione da sql/03 + sql/05)
-- ============================================================
-- Eseguire PRIMA di sql/translations/12 se la tabella e' vuota.
-- Idempotente: ON CONFLICT (slug) DO UPDATE -> aggiorna i campi IT.
-- 20 spiagge della Gallura/Costa Smeralda/Sardegna nord-orientale.
-- ============================================================

INSERT INTO public.seo_beaches (slug, title, h1, meta_description, content_html) VALUES

('spiaggia-del-principe',
 'Spiaggia del Principe | Come Arrivare in Auto — KS Rent',
 'Spiaggia del Principe: Come Arrivare e Dove Parcheggiare',
 'Spiaggia del Principe: la baia dell''Aga Khan in Costa Smeralda. Sentiero sterrato di 10 min dal parcheggio. Noleggia un SUV con KS Rent per arrivarci comodo.',
 '<p class="snippet-bait"><strong>La Spiaggia del Principe si raggiunge in auto da Porto Cervo in 10 minuti.</strong> Parcheggio a pagamento + sentiero sterrato di 10 minuti a piedi. KS Rent Sardinia consegna SUV e auto a Olbia, Porto Cervo e hotel. Senza carta di credito.</p>
...
('liscia-ruja',
 'Liscia Ruja (Long Beach) | Noleggio Auto — KS Rent',
 'Liscia Ruja: La Long Beach della Costa Smeralda in Auto',
 'Liscia Ruja: la spiaggia più grande della Costa Smeralda. Sabbia dorata, sterrato facile e parcheggio ampio. Noleggia SUV o city car con KS Rent da Olbia.',
 '<p class="snippet-bait"><strong>Liscia Ruja è la spiaggia più grande della Costa Smeralda: oltre 500 metri di sabbia dorata.</strong> Parcheggio sterrato ampio dietro la spiaggia. KS Rent Sardinia consegna auto ad Arzachena e Porto Cervo. Senza carta di credito.</p>
...
('cala-brandinchi',
 'Cala Brandinchi (Tahiti) | Parcheggio e Ingresso — KS Rent',
 'Cala Brandinchi: La Piccola Tahiti a Numero Chiuso',
 'Cala Brandinchi: ingresso a numero chiuso in estate, prenota online. Parcheggio custodito. Noleggia Jeep Avenger con KS Rent per lo sterrato da San Teodoro.',
 '<p class="snippet-bait"><strong>Cala Brandinchi è a numero chiuso in estate: prenota l''ingresso online.</strong> Parcheggio custodito a pagamento. Sterrato di accesso — Jeep Avenger consigliato. KS Rent Sardinia consegna auto a San Teodoro in 20 min da Olbia.</p>
...
('la-cinta',
 'La Cinta San Teodoro | 3 km di Sabbia — KS Rent',
 'Spiaggia La Cinta: 3 Chilometri di Sabbia Bianca a San Teodoro',
 'La Cinta: 3 km di sabbia bianca con fenicotteri, kitesurf e chioschi. Parcheggio a pagamento all''ingresso. Raggiungi in 2 min dal centro con auto KS Rent.',
 '<p class="snippet-bait"><strong>La Cinta è la spiaggia più grande di San Teodoro: 3 km di sabbia bianca con fenicotteri rosa.</strong> Parcheggio a pagamento all''ingresso. A 2 minuti dal centro in auto. KS Rent Sardinia consegna auto a San Teodoro.</p>
...
('lu-impostu',
 'Lu Impostu | Spiaggia vicino Brandinchi — KS Rent',
 'Lu Impostu: L''Alternativa Tranquilla a Cala Brandinchi',
 'Lu Impostu: 1 km di sabbia fine tra gigli e oleandri, meno affollata di Brandinchi. Parcheggio custodito. Noleggia auto con KS Rent da Olbia o Puntaldia.',
 '<p class="snippet-bait"><strong>Lu Impostu è l''alternativa meno affollata a Cala Brandinchi: 1 km di sabbia fine tra gigli selvatici e oleandri.</strong> Parcheggio custodito a pagamento. KS Rent Sardinia consegna auto da Olbia e Puntaldia.</p>
...
('capriccioli',
 'Capriccioli | Snorkeling Costa Smeralda — KS Rent',
 'Spiaggia di Capriccioli: Due Calette e il Miglior Snorkeling',
 'Capriccioli: due calette tra rocce di granito e macchia mediterranea. Fondali ricchissimi per snorkeling. Parcheggio limitato — arriva presto con auto KS Rent.',
 '<p class="snippet-bait"><strong>Capriccioli ha il miglior snorkeling della Costa Smeralda: due calette tra graniti rosa e posidonia.</strong> Parcheggio a pagamento molto limitato — arriva entro le 9:00 in estate. KS Rent Sardinia consegna auto a Porto Cervo.</p>
...
('romazzino',
 'Romazzino | Spiaggia Esclusiva Porto Cervo — KS Rent',
 'Spiaggia di Romazzino: Acque Smeraldo e Profumo di Rosmarino',
 'Romazzino: sabbia spessa e acqua cristallina nel cuore della Costa Smeralda. Parcheggi limitati agli hotel. Noleggia auto premium con KS Rent per arrivarci.',
 '<p class="snippet-bait"><strong>Romazzino è la spiaggia più esclusiva della Costa Smeralda, accanto all''hotel 5 stelle Romazzino.</strong> Acqua smeraldo e profumo di rosmarino selvatico. Parcheggi limitati. KS Rent Sardinia consegna auto premium.</p>
...
('grande-pevero',
 'Grande Pevero | Spiaggia VIP Porto Cervo — KS Rent',
 'Spiaggia del Grande Pevero: Tra il Golf Club e il Mare Cristallino',
 'Grande Pevero: mezzaluna di sabbia bianca accanto al Pevero Golf Club. Parcheggio a 500m dalla riva. Noleggia auto a Porto Cervo con KS Rent senza carta di credito.',
 '<p class="snippet-bait"><strong>Il Grande Pevero è la spiaggia VIP della Costa Smeralda, accanto al Pevero Golf Club.</strong> Parcheggio a pagamento a 500 metri dalla riva. Acque caraibiche e mega-yacht al largo. KS Rent Sardinia consegna auto premium.</p>
...
('cala-moresca',
 'Cala Moresca Golfo Aranci | Snorkeling — KS Rent',
 'Cala Moresca: Snorkeling e Natura Selvaggia a Golfo Aranci',
 'Cala Moresca: baia selvaggia con i fondali migliori per snorkeling a 15 min da Olbia. Parcheggio gratuito limitato. Noleggia Jeep Avenger con KS Rent.',
 '<p class="snippet-bait"><strong>Cala Moresca a Golfo Aranci è il miglior spot di snorkeling a 15 minuti da Olbia.</strong> Baia selvaggia e protetta, nessun servizio — porta tutto il necessario. Parcheggio gratuito limitato. KS Rent Sardinia consegna Jeep e auto.</p>
...
('cala-sabina',
 'Cala Sabina | Ginepri e Sabbia Bianca — KS Rent',
 'Cala Sabina: Ginepri Secolari e Sabbia Caraibica a Golfo Aranci',
 'Cala Sabina: ginepri secolari sulla sabbia, raggiungibile anche in treno. Parcheggio sterrato. Noleggia city car o SUV con KS Rent da Olbia in 15 minuti.',
 '<p class="snippet-bait"><strong>Cala Sabina è una delle poche spiagge raggiungibili anche in treno, ma in auto è un''altra esperienza.</strong> Ginepri secolari sulla sabbia, sapore tropicale. Parcheggio sterrato. KS Rent consegna auto a Golfo Aranci in 15 min.</p>
...
('spiaggia-bianca',
 'Spiaggia Bianca | Tra Olbia e Golfo Aranci — KS Rent',
 'Spiaggia Bianca: Dune, Gigli di Mare e Fondale Basso per Bambini',
 'Spiaggia Bianca: sabbia accecante tra Olbia e Golfo Aranci. Fondale bassissimo ideale per bambini. Parcheggio dietro le dune. Auto KS Rent da Pittulongu in 5 min.',
 '<p class="snippet-bait"><strong>Spiaggia Bianca si raggiunge in 5 minuti da Pittulongu: sabbia accecante, dune con gigli di mare e fondale bassissimo.</strong> Parcheggio ampio dietro le dune. KS Rent Sardinia consegna auto da Olbia in pochi minuti.</p>
...
('porto-istana',
 'Porto Istana | 4 Calette vista Tavolara — KS Rent',
 'Porto Istana: Quattro Calette di Fronte all''Isola di Tavolara',
 'Porto Istana: 4 calette con granito rosa e vista su Tavolara. Parcheggio a pagamento. Raggiungi in 2 min da Murta Maria con auto KS Rent senza carta di credito.',
 '<p class="snippet-bait"><strong>Porto Istana ha 4 calette di granito rosa con la vista più ravvicinata sull''Isola di Tavolara.</strong> Parcheggio a pagamento. A 2 minuti da Murta Maria. KS Rent Sardinia consegna auto da Olbia in 10 minuti.</p>
...
('porto-taverna',
 'Porto Taverna | Vista Frontale Tavolara — KS Rent',
 'Porto Taverna: Il Panorama Più Bello su Tavolara e Ristoranti sul Mare',
 'Porto Taverna: la vista più spettacolare su Tavolara. Passerella panoramica, ristoranti sulla spiaggia. Raggiungi da Porto San Paolo con auto KS Rent.',
 '<p class="snippet-bait"><strong>Porto Taverna offre la vista più spettacolare e frontale sull''Isola di Tavolara di tutta la Sardegna.</strong> Ristoranti di pesce sulla spiaggia. Parcheggio a pagamento. KS Rent consegna auto da Olbia in 15 min.</p>
...
('rena-bianca',
 'Rena Bianca Santa Teresa | Bandiera Blu — KS Rent',
 'Rena Bianca: Bandiera Blu con Vista sulla Corsica',
 'Rena Bianca: Bandiera Blu nel centro di Santa Teresa Gallura. Sabbia impalpabile con vista su Bonifacio. Parcheggio limitato. Auto KS Rent da Olbia in 55 min.',
 '<p class="snippet-bait"><strong>Rena Bianca è Bandiera Blu nel centro di Santa Teresa Gallura, con vista sulle falesie di Bonifacio in Corsica.</strong> Parcheggio limitato — arriva presto. KS Rent consegna Mercedes e Jeep da Olbia in 55 min.</p>
...
('cala-del-faro',
 'Cala del Faro | Tramonto Baja Sardinia — KS Rent',
 'Cala del Faro: Tramonti Spettacolari e Fondale Basso a Baja Sardinia',
 'Cala del Faro: spiaggia elegante a nord di Porto Cervo con vista sull''Arcipelago della Maddalena. Parcheggio limitato. Auto KS Rent con consegna in hotel.',
 '<p class="snippet-bait"><strong>Cala del Faro è la spiaggia dei tramonti più belli della Costa Smeralda, a pochi minuti da Baja Sardinia.</strong> Fondale basso e sabbioso. Parcheggio limitato. KS Rent consegna auto con servizio premium in hotel.</p>
...
('la-celvia',
 'La Celvia | Spiaggia VIP Costa Smeralda — KS Rent',
 'La Celvia: Sabbia Ambrata e Ville di Lusso in Costa Smeralda',
 'La Celvia: sabbia a grana grossa dai riflessi ambrati, meta dei VIP. Parcheggio limitato nei weekend. Noleggia auto premium con KS Rent senza carta di credito.',
 '<p class="snippet-bait"><strong>La Celvia è la spiaggia preferita dai VIP della Costa Smeralda: sabbia ambrata a grana grossa che non si attacca alla pelle.</strong> Ville di lusso nella macchia mediterranea. KS Rent consegna auto premium senza carta di credito.</p>
...
('spiaggia-marinella',
 'Spiaggia Marinella | Sport e Lounge Bar — KS Rent',
 'Spiaggia di Marinella: Chilometri di Sabbia, Sport e Lounge Bar',
 'Spiaggia Marinella: km di sabbia per windsurf e famiglie. Stabilimenti che diventano lounge bar al tramonto. Parcheggio ampio. Auto KS Rent da Porto Rotondo.',
 '<p class="snippet-bait"><strong>Spiaggia di Marinella: chilometri di sabbia tra Porto Rotondo e Golfo Aranci, con stabilimenti che diventano lounge bar al tramonto.</strong> Parcheggio ampio a pagamento. KS Rent consegna auto da Olbia in 20 min.</p>
...
('spiaggia-bados',
 'Spiaggia Bados | Relax vicino Olbia — KS Rent',
 'Spiaggia di Bados: Sabbia Fine e Acque Calme a Due Passi da Olbia',
 'Spiaggia Bados: fondale dolcissimo e acque calme, perfetta per famiglie. Parcheggio davanti alla spiaggia. Auto KS Rent con consegna rapida da Olbia.',
 '<p class="snippet-bait"><strong>Spiaggia Bados: la spiaggia più tranquilla di Olbia con fondale dolcissimo, ideale per famiglie con bambini.</strong> Parcheggio davanti alla spiaggia. KS Rent consegna auto in pochi minuti dalla sede.</p>
...
('spiaggia-pittulongu',
 'Pittulongu La Playa | Spiaggia Olbia — KS Rent',
 'Pittulongu La Playa: La Spiaggia Storica degli Olbiesi',
 'Pittulongu: la spiaggia dei residenti di Olbia. Ristoranti di pesce con i piedi sulla sabbia. A pochi minuti dall''aeroporto. Auto KS Rent con consegna express.',
 '<p class="snippet-bait"><strong>Pittulongu "La Playa": la spiaggia storica degli olbiesi, a pochi minuti dall''aeroporto.</strong> Ristoranti di pesce con i piedi sulla sabbia. Parcheggio lungo la via principale. KS Rent consegna auto express.</p>
...
('capo-testa',
 'Capo Testa | Valle della Luna e Graniti — KS Rent',
 'Capo Testa: Valle della Luna, Graniti Millenari e Due Spiagge',
 'Capo Testa: penisola di granito con Valle della Luna e due spiagge. Rena di Ponente o Levante in base al vento. Auto KS Rent da Santa Teresa in 5 min.',
 '<p class="snippet-bait"><strong>Capo Testa è una penisola di granito millenario con la Valle della Luna e due spiagge: scegli in base al vento.</strong> Rena di Ponente con Maestrale, Rena di Levante con Scirocco. KS Rent consegna auto da Olbia in 55 min.</p>
...
-- VERIFICA
-- ============================================================
-- SELECT count(*) FROM public.seo_beaches;
-- -- atteso: 20
--
-- SELECT slug, title, length(content_html) AS html_len
