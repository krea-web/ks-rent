  ...
  it: {
    ...
    how: {
      ...
      steps: [
        ...
        { title: "Conferma la Prenotazione", desc: "Ricevi conferma istantanea via email e WhatsApp con tutti i dettagli, incluso l'importo del deposito cauzionale." },
  ...
  en: {
    ...
    how: {
      ...
      steps: [
        ...
        { title: "Confirm the Booking", desc: "Receive instant confirmation by email and WhatsApp with all the details, including the security deposit amount." },
  ...
  de: {
    ...
    how: {
      ...
      steps: [
        ...
        { title: "Buchung bestätigen", desc: "Sie erhalten sofortige Bestätigung per E-Mail und WhatsApp mit allen Details, inklusive Kautionsbetrag." },
  ...
  fr: {
    ...
    how: {
      ...
      steps: [
        ...
        { title: "Confirmez la réservation", desc: "Recevez la confirmation immédiate par e-mail et WhatsApp avec tous les détails, y compris le montant du dépôt de garantie." },
    ...
    rich: {
      ...
      pHtml: [
        ...
        "<strong>Comment fonctionne le dépôt de garantie sans carte de crédit ?</strong> Le montant varie selon la catégorie du véhicule : une citadine comme la Fiat Panda demande un dépôt réduit, tandis qu'une supercar comme l'Audi RS3 ou la BMW M2 prévoit une caution plus élevée, proportionnelle à la valeur du véhicule. Le montant exact est communiqué lors de la réservation en ligne, avant la confirmation, ainsi il n'y a jamais de surprise. Au moment du retrait, vous versez le dépôt en espèces ou par prépayée, signez le contrat et partez. À la restitution, après une vérification rapide du véhicule, le dépôt est restitué immédiatement.",
