  ...
  return (
    <div className="bg-gray-50 dark:bg-[#050505] text-foreground selection:bg-gold selection:text-black overflow-x-hidden">
      <SEOHead
        ...
        keywords="noleggio auto senza carta di credito, noleggio senza carta di credito sardegna, noleggio auto senza carta di credito olbia, autonoleggio senza carta credito, rent a car senza carta di credito, noleggio auto prepagata olbia, noleggio auto contanti sardegna, noleggio auto olbia, autonoleggio olbia, noleggio supercar olbia, noleggio auto costa smeralda"
      ...
      <section className="py-24 px-4 md:px-12 lg:px-24 bg-[#0a0a0a]">
        <div className="max-w-4xl mx-auto">
          ...
          <h2 className="text-3xl md:text-5xl font-display font-black mb-12 italic uppercase tracking-tighter text-center">
          ...
          <div className="space-y-8">
            {[
              ...
              <motion.div
                ...
                className="flex gap-6 items-start p-6 rounded-2xl bg-white/[0.03] border border-white/10"
              >
                <span className="text-gold font-black text-3xl italic">{s.step}</span>
                <div>
                  <h3 className="text-xl font-bold uppercase italic tracking-tighter mb-2">{s.title}</h3>
      ...
      <section className="py-24 px-4 md:px-12 lg:px-24 bg-[#050505]">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-6 text-white/60 text-base md:text-lg leading-relaxed font-light">
            <p>
              Uno dei problemi più comuni che i turisti incontrano quando cercano un <strong className="text-white/80">noleggio auto in Sardegna</strong> è l'obbligo della carta di credito. La maggior parte delle grandi compagnie internazionali — Hertz, Avis, Europcar, Sixt — richiede una carta di credito tradizionale con plafond elevato per poter bloccare il deposito cauzionale. Questo esclude automaticamente milioni di viaggiatori che utilizzano carte prepagate come PostePay, Revolut, N26 o Hype, oppure che preferiscono pagare in contanti.
            </p>
            <p>
              <strong className="text-white/80">KS Rent ha scelto una strada diversa.</strong> Crediamo che la flessibilità nel pagamento sia un diritto, non un lusso. Per questo accettiamo qualsiasi metodo di pagamento: carte prepagate di ogni circuito (Visa, Mastercard), bancomat, carte di debito, contanti e bonifici istantanei. Il deposito cauzionale — obbligatorio per garantire la cura del veicolo — può essere versato con uno qualsiasi di questi strumenti. Nessun blocco fondi sulla carta, nessuno score bancario, nessuna pre-autorizzazione incomprensibile.
            </p>
            <p>
              <strong className="text-white/80">Come funziona il deposito cauzionale senza carta di credito?</strong> L'importo varia in base alla categoria del veicolo: una city car come la Fiat Panda richiede un deposito contenuto, mentre una supercar come l'Audi RS3 o la BMW M2 prevede una cauzione più elevata, commisurata al valore del mezzo. L'importo esatto viene comunicato durante la prenotazione online, prima della conferma, così non ci sono mai sorprese. Al momento del ritiro, versi il deposito in contanti o con la tua prepagata, firmi il contratto e parti. Alla riconsegna, dopo una rapida verifica del veicolo, il deposito viene restituito immediatamente.
            </p>
            <p>
              Questa politica ci ha reso un punto di riferimento per il <strong className="text-white/80">noleggio auto senza carta di credito a Olbia e in Costa Smeralda</strong>. Serviamo clienti all'{" "}
              <Link to="/noleggio-auto-aeroporto-olbia" className="text-gold underline hover:text-white transition-colors">Aeroporto di Olbia Costa Smeralda</Link>, al{" "}
              <Link to="/noleggio-auto-porto-olbia" className="text-gold underline hover:text-white transition-colors">Porto di Olbia Isola Bianca</Link> e in tutta la{" "}
