  ...
  return (
    <div className="bg-gray-50 dark:bg-[#050505] text-foreground selection:bg-gold selection:text-black overflow-x-hidden font-sans pt-24 md:pt-32">
      ...
      <section className="py-24 px-4 md:px-12 lg:px-24 bg-white dark:bg-[#050505] shadow-md dark:shadow-none border-b-[3px] border-b-gold/40 dark:border-b-transparent relative">
        ...
        <div className="max-w-5xl mx-auto text-center md:text-left relative z-10">
          ...
          >
            ...
            <p className="text-gray-600 dark:text-white/60 text-lg md:text-xl leading-relaxed max-w-4xl">
              ...
              <Link to="/noleggio-auto-porto-olbia" className="text-gold underline hover:text-gray-900 dark:hover:text-white transition-colors">Porto di Olbia</Link> o all'{" "}
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="order-1 lg:order-2 text-center lg:text-left">
            ...
            <h2 className="text-4xl md:text-7xl font-black mb-8 italic uppercase tracking-tighter leading-none text-gray-900 dark:text-white outline-text-gold">
              Noleggio BMW M2 <br />
              <span className="text-gray-900 dark:text-white">Costa Smeralda</span>
            </h2>
            <p className="text-gray-600 dark:text-white/60 text-xl mb-12 italic font-light leading-relaxed">
            ...
            <div className="grid grid-cols-2 gap-8 mb-12 max-w-sm mx-auto lg:mx-0">
              <div className="flex items-center gap-4 justify-center lg:justify-start bg-gray-50 dark:bg-white/5 p-4 rounded-xl border border-gray-200 dark:border-white/10">
                ...
                <div>
                  <p className="text-2xl font-black text-gray-900 dark:text-white italic">460</p>
              ...
              <div className="flex items-center gap-4 justify-center lg:justify-start bg-gray-50 dark:bg-white/5 p-4 rounded-xl border border-gray-200 dark:border-white/10">
                ...
                <div>
                  <p className="text-2xl font-black text-gray-900 dark:text-white italic">RWD</p>
      ...
      <section className="py-24 px-4 md:px-12 lg:px-24 bg-gray-50 dark:bg-[#050505]">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-6 text-gray-600 dark:text-white/60 text-base md:text-lg leading-relaxed font-light">
            <p>
              La <strong className="text-gray-800 dark:text-white/80">Costa Smeralda</strong> è una delle destinazioni più esclusive del Mediterraneo. Fondata negli anni '60 dal Principe Aga Khan, questo tratto di costa nord-orientale della Sardegna si estende da <Link to="/noleggio-auto-porto-rotondo" className="text-gold underline hover:text-gray-900 dark:hover:text-white transition-colors">Porto Rotondo</Link> fino a <Link to="/noleggio-auto-baja-sardinia" className="text-gold underline hover:text-gray-900 dark:hover:text-white transition-colors">Baja Sardinia</Link>, passando per <Link to="/noleggio-auto-porto-cervo" className="text-gold underline hover:text-gray-900 dark:hover:text-white transition-colors">Porto Cervo</Link>, Cala di Volpe, <Link to="/romazzino" className="text-gold underline hover:text-gray-900 dark:hover:text-white transition-colors">Romazzino</Link> e <Link to="/liscia-ruja" className="text-gold underline hover:text-gray-900 dark:hover:text-white transition-colors">Liscia Ruja</Link>. Le sue spiagge di sabbia bianchissima, le acque turchesi e i porti turistici di lusso attirano ogni anno migliaia di visitatori internazionali, celebrità e appassionati di lifestyle premium.
            </p>
            <p>
              <strong className="text-gray-800 dark:text-white/80">Perché noleggiare un'auto in Costa Smeralda?</strong> Semplice: molte delle spiagge e delle calette più belle non sono raggiungibili con i mezzi pubblici. La litoranea da Olbia a <Link to="/noleggio-auto-palau" className="text-gold underline hover:text-gray-900 dark:hover:text-white transition-colors">Palau</Link> è considerata una delle strade panoramiche più spettacolari d'Italia, con curve che si affacciano su baie nascoste e promontori di granito rosa. Guidare una supercar o una sportiva su queste strade è un'esperienza che trasforma una vacanza in un ricordo indimenticabile. Da Porto Cervo a San Pantaleo — il borgo hipster della Gallura con le sue boutique e i ristoranti stellati — ogni chilometro è un invito a scoprire qualcosa di nuovo.
            </p>
            <p>
              Il servizio <strong className="text-gray-800 dark:text-white/80">Concierge KS Rent</strong> è stato pensato per chi non vuole perdere neanche un minuto della propria vacanza. Ti consegniamo il veicolo esattamente dove ti trovi: nella hall del tuo Hotel a Porto Cervo, nel parcheggio della tua Villa privata ad Abbiadori, al ristorante dove stai cenando ad <Link to="/noleggio-auto-arzachena" className="text-gold underline hover:text-gray-900 dark:hover:text-white transition-colors">Arzachena</Link> o persino al marina di <Link to="/noleggio-auto-poltu-quatu" className="text-gold underline hover:text-gray-900 dark:hover:text-white transition-colors">Poltu Quatu</Link>. Il ritiro avviene allo stesso modo: basta una chiamata e un nostro addetto verrà a prendere l'auto dove preferisci. Nessuno spostamento, nessun taxi, nessuna perdita di tempo.
            </p>
            <p>
              La nostra flotta dedicata alla Costa Smeralda include i veicoli più desiderati: dall'<strong className="text-gray-800 dark:text-white/80">Audi RS3</strong> alla <strong className="text-gray-800 dark:text-white/80">BMW M2</strong>, dai SUV di ultima generazione ai quad per le strade sterrate che portano alle spiagge segrete. Tutto disponibile <strong className="text-gray-800 dark:text-white/80">senza obbligo di carta di credito</strong> — una rarità nel mondo del noleggio auto di lusso. Accettiamo prepagate, bancomat e contanti. Prenota in autonomia dal sito e ricevi la conferma in pochi minuti. Per chi arriva in Sardegna, offriamo anche il ritiro all'{" "}
              <Link to="/noleggio-auto-aeroporto-olbia" className="text-gold underline hover:text-gray-900 dark:hover:text-white transition-colors">Aeroporto di Olbia</Link> e al{" "}
      ...
      <section className="py-16 px-4 md:px-12 max-w-7xl mx-auto text-gray-700 dark:text-white/80 font-light leading-relaxed">
        <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-6">Esplora con il nostro Noleggio Auto in Costa Smeralda</h2>
        <p className="mb-4">
