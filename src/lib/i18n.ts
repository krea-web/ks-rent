...
const PATH_MAP_FULL: Record<string, Record<Locale, string>> = {
  ...
  "/noleggio-moto-scooter-olbia":                  { it: "/noleggio-moto-scooter-olbia",                     en: "/scooter-motorbike-rental-olbia",         de: "/motorrad-roller-mieten-olbia",           fr: "/location-scooter-moto-olbia" },
  "/noleggio-auto-sportive-olbia":                 { it: "/noleggio-auto-sportive-olbia",                    en: "/sports-car-hire-olbia",                  de: "/sportwagen-mieten-olbia",                fr: "/location-voiture-sportive-olbia" },
