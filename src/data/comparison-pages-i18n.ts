...
export const COMPARISONS: ComparisonMeta[] = [
  ...
  },
  {
    ...
    intro: {
      it: "Jeep Avenger e Fiat Panda Hybrid sono le due opzioni piu' popolari del noleggio economico-pratico a Olbia. La Jeep Avenger e' un SUV compatto da 100 CV con cambio automatico DCT, posizione di guida rialzata e bagagliaio da 380 L: pensata per famiglie e per chi vuole raggiungere spiagge nascoste su sterrato (Spiaggia del Principe, Liscia Ruja, Capriccioli). La Fiat Panda Hybrid 70 CV con cambio manuale 5 marce e bagagliaio da 225 L e' la city car simbolo dell'Italia: la piu' economica della flotta KS Rent Sardinia (55 €/giorno bassa stagione), perfetta per centri storici stretti, parcheggi affollati di Porto Cervo in alta stagione e single/coppie con poco bagaglio. Stessa stagione tariffaria (aprile-ottobre), priorita' diversa.",
      en: "Jeep Avenger and Fiat Panda Hybrid are the two most popular options in the value-practical rental segment in Olbia. The Jeep Avenger is a 100 HP compact SUV with DCT automatic, raised driving position and 380 L boot: designed for families and those who want to reach hidden beaches via dirt roads (Spiaggia del Principe, Liscia Ruja, Capriccioli). The Fiat Panda Hybrid 70 HP with 5-speed manual gearbox and 225 L boot is Italy's symbolic city car: the most economical in the KS Rent Sardinia fleet (€55/day low season), perfect for tight historic centres, crowded Porto Cervo parking in high season, and singles/couples with light luggage. Same seasonal calendar (April-October), different priority.",
      de: "Jeep Avenger und Fiat Panda Hybrid sind die beiden beliebtesten Optionen im preiswert-praktischen Mietsegment in Olbia. Der Jeep Avenger ist ein 100 PS Kompakt-SUV mit DCT-Automatik, erhoehter Sitzposition und 380 L Kofferraum: konzipiert fuer Familien und alle, die versteckte Straende ueber Schotterpisten erreichen wollen (Spiaggia del Principe, Liscia Ruja, Capriccioli). Der Fiat Panda Hybrid 70 PS mit 5-Gang-Schaltgetriebe und 225 L Kofferraum ist der italienische Inbegriff des Kleinwagens: der guenstigste in der KS Rent Sardinia-Flotte (55 €/Tag in der Nebensaison), perfekt fuer enge Altstaedte, ueberfuellte Porto Cervo-Parkplaetze in der Hochsaison und Singles/Paare mit leichtem Gepaeck. Gleiche Saison (April-Oktober), andere Prioritaet.",
      fr: "Jeep Avenger et Fiat Panda Hybrid sont les deux options les plus populaires du segment economique-pratique a Olbia. Le Jeep Avenger est un SUV compact de 100 ch avec boite automatique DCT, position de conduite surelevee et coffre de 380 L : pense pour les familles et qui veut rejoindre les plages cachees par chemin de terre (Spiaggia del Principe, Liscia Ruja, Capriccioli). La Fiat Panda Hybrid 70 ch avec boite manuelle 5 vitesses et coffre de 225 L est la citadine symbole de l'Italie : la plus economique de la flotte KS Rent Sardinia (55 €/jour basse saison), parfaite pour les centres historiques etroits, les parkings bondes de Porto Cervo en haute saison et les celibataires/couples avec peu de bagages. Meme saison tarifaire (avril-octobre), priorite differente.",
    },
    breadcrumbName: {
