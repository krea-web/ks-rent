...
const WhatsAppCTA = () => (
  <a
    ...
    className="fixed right-6 z-[9998] bottom-6 max-lg:bottom-[calc(4.5rem+env(safe-area-inset-bottom))] flex items-center justify-center w-14 h-14 rounded-full bg-[#25D366] shadow-lg hover:scale-110 transition-transform"
