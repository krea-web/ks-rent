...
const logo = "https://zgytnkimjpoosvshfopz.supabase.co/storage/v1/object/public/asset/KSRENTkimjpoosvshfopz.supabase.co/storage/v1/object/public/asset/KSRENTkimjpoosvshfopz.supabase.co/storage/v1/object/public/asset/KSRENTlogo.png";
 ...
 width={120} height={48}          <img src={logo} alt="KS Rent Noleggio Auto Lusso Olbia" className="h-12 w-auto mb-4" loading="lazy" />
          ...
          <div className="flex flex-col gap-5 text-sm text-muted-foreground">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                Viale Isola Bianca 38<br />07026, Olbia (SS)
              </div>
            </div>
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                Viale Aldo Moro 367<br />07026, Olbia (SS)
              </div>
            </div>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="flex flex-col gap-4 text-sm text-muted-foreground">
            <a href="tel:+393446107071" className="flex items-center gap-3 hover:text-gold transition-colors group relative z-20">
              <div className="p-2 bg-white/5 rounded-full group-hover:bg-gold/10 transition-colors">
                <Phone size={16} className="text-gold" />
              </div>
              +39 344 610 7071
            </a>
            <a href="mailto:ksrentsrl@gmail.com" className="flex items-center gap-3 hover:text-gold transition-colors group relative z-20">
              <div className="p-2 bg-white/5 rounded-full group-hover:bg-gold/10 transition-colors">
    ...
    <div className="relative z-10 border-t border-white/10 mt-6 md:mt-8 pt-6">
      <div className="container mx-auto px-4 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-muted-foreground">
        ...
        <div className="flex flex-wrap justify-center gap-4">
          <Link to="#" className="hover:text-gold transition-colors relative z-20">Privacy Policy</Link>
          <Link to="#" className="hover:text-gold transition-colors relative z-20">Termini di Servizio</Link>
